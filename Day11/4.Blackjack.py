#Since we cann't call the function before defining it hence moving calculate_score function above where we dealt the cards
...
for _ in range (2):
    user_cards.append(deal_card())       # we cannot use user_card += new_card . Because this line acts like user_card.extend(new_card) which takes another list as input
